...
const DEFAULT_DEMO_BANNERS: HeroBannerRecord[] = [
    {
        ...
        discount_tag: '20% OFF',
        image_url: 'https://images.unsplash.com/photo-1539185441755-769473a23570?q=80&w=1200&auto=format&fit=crop',
        mobile_image_url: 'https://images.unsplash.com/photo-1539185441755-769473a23570?q=80&w=600&auto=format&fit=crop',
