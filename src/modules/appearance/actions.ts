...
const DEFAULT_DEMO_BANNERS: HeroBannerRecord[] = [
    {
        ...
        subtitle: 'Encuentra tus productos favoritos. Descubre las últimas novedades, accesorios y catálogo seleccionado.',
        badge_text: 'EDICIÓN 2026',
        price_amount: null,
    ...
    {
        id: 'banner-demo-2',
        title: 'DISPOSITIVOS & KITS DESTACADOS',
        subtitle: 'Rendimiento superior con la mejor selección de equipos, cartuchos y tecnología avanzada.',
    ...
    },
    {
        ...
        subtitle: 'Aprovecha precios especiales en productos seleccionados por tiempo limitado.',
        badge_text: 'PROMOCIÓN EXCLUSIVA',
        price_amount: 79.90,
